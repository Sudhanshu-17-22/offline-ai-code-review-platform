...
describe("Review API Endpoints", () => {
    ...
    describe("POST /api/reviews", () => {
        it("should create a new review", async () => {
            ...
            expect(
                response.body.data?.overallScore ??
                response.body.data?.review?.overallScore
            ).toBeDefined();
        });
    ...
    describe("GET /api/reviews/:id", () => {
        it("should retrieve a review by ID", async () => {
            ...
            expect(returnedReview._id.toString()).toBe(
                review._id.toString()
            );
        });
    ...
    describe("GET /api/reviews", () => {
        ...
        it("should filter reviews by language", async () => {
            ...
            expect(response.body.data.reviews[0].language).toBe(
                "javascript"
            );
        });
        ...
        it("should filter reviews by score range", async () => {
            ...
            const highScoreReview = reviews.find(
                (item: any) => item.overallScore === 90
            );
        ...
        it("should search reviews by filename", async () => {
            ...
            expect(response.status).toBe(200);
            expect(response.body.data.reviews.length).toBe(1);
            expect(response.body.data.reviews[0].fileName).toBe(
                "fibonacci.js"
            );
        });
    });
